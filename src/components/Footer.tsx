    ...
    >
      <div className="max-w-360 w-full">
        <div className="flex flex-col lg:flex-row gap-28 justify-between items-start ">
          ...
          <div className="  grid grid-cols-2 items-start w-full lg:flex lg:flex-row gap-6  ">
            ...
            {/* Column 2 — Pages */}
            <div className="text-start w-full col-span-1">
            ...
            <div className="text-start w-full col-span-1">
              ...
              <div className="mt-5 w-full flex justify-start items-end  flex-wrap gap-2  ">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-4">
              ...
              >
                ...
                >
                  <path
                    d="M26.25 14C26.25 10.7511 24.9594 7.63527 22.662 5.33795C20.3647 3.04063 17.2489 1.75001 14 1.75001C10.9153 1.74716 7.94316 2.90814 5.67715 5.00105C3.41114 7.09395 2.01812 9.96471 1.77635 13.0399C1.53459 16.115 2.46186 19.1682 4.37296 21.5895C6.28406 24.0108 9.03829 25.622 12.0855 26.1013V17.5403H8.97748V14H12.0872V11.3015C12.0872 8.232 13.916 6.53451 16.7142 6.53451C18.0547 6.53451 19.4565 6.77426 19.4565 6.77426V9.7895H17.9112C16.3887 9.7895 15.9162 10.7345 15.9162 11.7023V14H19.313L18.7705 17.5403H15.9145V26.1013C18.7959 25.645 21.4199 24.1755 23.3145 21.9572C25.2091 19.7389 26.25 16.9173 26.25 14Z"
                    fill="var(--Brand, #F0A647)"
                  />
                  <path
              ...
              <div data-svg-wrapper className="w-6 h-6" />
            </div>
          </div>
        </div>
      </div>
